...
and
\begin{align*}
\left(A^e_1\otimes A^e_2(-1)\right)\oplus\left(A^e_1(-1)\otimes A^e_2\right)&\cong \left(A^e\right)^2\\
\begin{bmatrix} x_1^a\otimes x_1^b\otimes x_2^c\otimes x_2^d\\x_1^r\otimes x_1^s\otimes x_2^u\otimes x_2^v\end{bmatrix}&\mapsto\begin{bmatrix}q^{b(c+1)}x_1^ax_2^c\otimes x_1^bx_2^d\\q^{(s+1)v}x_1^rx_2^u\otimes x_1^sx_2^v \end{bmatrix}
\end{align*}
...
where the differentials are given by
\begin{align*}
\partial^*_2(x_1^ax_2^b\otimes x_1^cx_2^d)=\begin{bmatrix} \end{bmatrix}
\end{align*}
...
We also have that
\begin{align*}
\Hom_{A^e}(\left(A_1^e\otimes A_2^e(-1)\right)\oplus\left(A_1^e(-1)\otimes A_2^e\right),A)&\cong A\otimes \Wedge_q^1(V)
\end{align*}
