...
\begin{beamerboxesrounded}{Question}
    Under what conditions does a PBW deformation of \(R\#H\) \\extend to a PBW deformation of \(R\, \#\, H[x;\sigma,\delta]\) or to a Hopf quotient of \(R\,\#\, H[x;\sigma,\delta]\,\)?
...
\end{itemize}
\begin{example}
   The 4-dim Sweedler alg, \(H_4\), is a Hopf quotient of a Hopf-Ore ext of the group alg \(k[\mathbb{Z}/2\mathbb{Z}]\) and acts on the Koszul alg \(k[u,v]\).
